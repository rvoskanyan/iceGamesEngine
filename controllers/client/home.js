...
export const homepage = async (req, res) => {
  ...
  const countSales = orders.reduce((countSales, order) => countSales + order.items.length, 9000);
  ...
  res.render('home', {
    ...
    metaDescription: 'ICE GAMES - магазин лицензионных ключей активации, предоставляющий удобную корзину с возможностью купить как один ключ так и несколько за одну транзакцию с моментальной доставкой и гарантией для таких сервисов, как Steam, Origin, Epic Games, GOG, Uplay, Battle.net и других, для более, чем 2000 наименований в 16 различных жанрах. Сервисная поддержка, увлекательные статьи и большое активное комьюнити гарантированны!',
